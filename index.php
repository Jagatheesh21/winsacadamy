                  ...
                  <div class="row align-items-center">
                     <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="hero__content hero__content-2 p-relative z-index-1">
                           ...
                           What Wins Academy offers you? <br> 
                              <span class="yellow-shape">Free Counseling <img src="assets/img/shape/yellow-bg.png" alt="yellow-shape"> </span>
                           </h3>
                           <h4>Wins Academy Providing to you for Free counseling to Switch your domain to IT.</h4>
                           <p> and Help to take Decisions for Your Bright Future</p>
                     ...
                     <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="hero__thumb-wrapper mb--120">
                           <div class="hero__thumb-2 scene">
                              <img class="hero-big" src="assets/img/home/hero.png" alt="">
                              ...
                              <div class="hero__promotion education d-none d-lg-flex white-bg layer" data-depth="0.2" >
                                 ...
                                 <div class="hero__promotion-text">
                                    <h5><span data-purecounter-duration="1" data-purecounter-end="450" class="purecounter">0</span>K</h5>
               ...
               <div class="row">
                  <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
                     <div class="section__title-wrapper section-padding mb-60 text-center">
                        <h2 class="section__title">What <span class="yellow-bg">Wins Academy <img src="assets/img/shape/yellow-bg-2.png" alt=""></span> offers you</h2>
               ...
               <div class="row">
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item blue-bg-4 mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="#">Free  <br> Counseling</a></h3>
                           <p>Wins Academy Providing to you for Free counseling to Switch your domain to IT. and Help to take Decisions for Your Bright Future</p>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item pink-bg mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="#">Placement
<br> Preparation</a></h3>
                           <p>Wins Academy Take your Future responsibilities and provide End to End Placement <br> support to you</p>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item purple-bg mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="#">Live<br> classes</a></h3>
                           <p>Wins Academy Provide Live Online & Offline Classes with Guranted Placement support, we are also provide one to one Session.</p>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="services__item green-bg mb-30">
                        ...
                        <div class="services__content">
                           <h3 class="services__title"><a href="#">Industrial<br>Experience</a></h3>
                           <p>Wins academy Not only Providing Teaching/Practical sessions. we provide Industrial Experience with our partner companies</p>
                  ...
                  <div class="col-xxl-5 offset-xxl-1 col-xl-6 col-lg-6">
                     <div class="about__thumb-wrapper">
                        ...
                        <div class="about__review">
                           <h5> <span>200+</span> five star reviews</h5>
                        </div>
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="about__content pl-70 pr-60 pt-25">
                        <div class="section__title-wrapper mb-25">
                           <h2 class="section__title">Achieve goals with <br><span class="yellow-bg-big"><?=$company_name;?> <img src="assets/img/shape/yellow-bg-2.png" alt=""></span> </h2>
                        ...
                        <div class="about__list mb-35">
                           <ul>
                              <li class="d-flex align-items-center"> <i class="icon_check"></i>Develop skills for real career growth</li>
                              <li class="d-flex align-items-center"> <i class="icon_check"></i> Learn from experts active in their field, not out-of-touch trainers</li>
                              <li class="d-flex align-items-center"> <i class="icon_check"></i> Learn by working on real-world problems</li>
                              <li class="d-flex align-items-center"> <i class="icon_check"></i> Structured guidance ensuring learning never stops</li>
                           </ul>
                        </div>
                  ...
                  <div class="col-xxl-7 col-xl-6 col-lg-6">
                     <div class="course__menu d-flex justify-content-lg-end mb-60">
                        <div class="masonary-menu filter-button-group">
                           ...
                           <button data-filter=".cat4">Graphic Design</button>
                       </div>
                     </div>
                  </div>
               </div>
               <div class="row grid">
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat3 cat4">
                     <div class="course__item white-bg mb-30 fix">
                           ...
                           <a href="course_details.php?course=<?=$id;?>">
                              <img src="<?=$row['image_url'];?>" alt="">
                           </a>
                           <div class="course__tag">
                              <a href="course_details.php?course=<?=$id;?>" class="sky-blue"><?=$row['name'];?></a>
                           </div>
                           </div>
                           ...
                           <h3 class="course__title"><a href="course_details.php?course=<?=$id;?>"><?=$row['description'];?></a></h3>
                           ...
                           <div class="course__btn">
                              <a href="course_details.php?course=<?=$id;?>" class="link-btn">
                                 Know Details
                                 <i class="far fa-arrow-right"></i>
                                 <i class="far fa-arrow-right"></i>
                              </a>
                  ...
                  <div class="course__item white-bg mb-30 fix">
                     ...
                     <div class="course__content">
                        ...
                        <h3 class="course__title"><a href="#">Architecting precision through automated solutions.</a></h3>
                        <div class="course__teacher d-flex align-items-center">
                           <div class="course__teacher-thumb mr-15">
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat4 cat1 cat3">
                     <div class="course__item white-bg mb-30 fix">
                        ...
                        <div class="course__content">
                           ...
                           <h3 class="course__title"><a href="course-details.html">Learn and Make a Digital world in your style.</a></h3>
                           <div class="course__teacher d-flex align-items-center">
                              <div class="course__teacher-thumb mr-15">
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2 cat4">
                     <div class="course__item white-bg mb-30 fix">
                        ...
                        <div class="course__content">
                           ...
                           <h3 class="course__title"><a href="course-details.html">Elevating efficiency and collaboration.</a></h3>
                           <div class="course__teacher d-flex align-items-center">
                              <div class="course__teacher-thumb mr-15">
         ...
         <!-- what area start -->
         <section class="what__area pt-115" style="display: none;">
            <div class="container">
               <div class="row">
         ...
         <!-- why area start -->
         <section class="why__area pt-125" style="display: none;">
            <div class="container">
               <div class="row align-items-center">
         ...
         <section class="counter__area pt-145 pb-100">
            <div class="container">
               ...
               <div class="row">
                  <div class="col-xxl-2 offset-xxl-1 col-xl-2 offset-xl-3 col-lg-3 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
                     <div class="counter__item mb-30">
                        ...
                        <div class="counter__content">
                           <h4><span data-purecounter-duration="1" data-purecounter-end="500" class="purecounter">0</span></h4>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-5">
                     <div class="counter__item counter__pl-80 mb-30">
                        ...
                        <div class="counter__content">
                           <h4><span data-purecounter-duration="1" data-purecounter-end="60" class="purecounter">0</span></h4>
                           <p>Total Courses</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-2 offset-xxl-0 col-xl-3 offset-xl-0 col-lg-3 offset-lg-0 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
                     <div class="counter__item counter__pl-34 mb-30">
                        ...
                        <div class="counter__content">
                           <h4><span data-purecounter-duration="1" data-purecounter-end="250" class="purecounter">0</span></h4>
                           <p>Online Learners</p>
                        </div>
                     </div>
                  </div>
         ...
         <section class="testimonial__area testimonial__overlay pt-175 pb-170" data-background="assets/img/testimonial/testimonial-bg.jpg" style="display:none;">
            <div class="container">
         ...
         <!-- blog area start -->
         <section class="blog__area pt-115 pb-130" style="display: none;">
            <div class="container">
               <div class="row">
